...
public class MainActivity<startButtonClickListener, answerButtonClickListener> extends AppCompatActivity {

    Button btn_start, btn_answer0, btn_answer1, btn_answer2, btn_answer3, btn_answer4;
    ...
    CountDownTimer timer = new CountDownTimer(30000, 1000) {
        ...
        public void onFinish() {
            ...
            tv_bottommessage.setText("Time is up! " + g.getCurrentQuestion() + "/" + (g.getTotalQuestions() - 1));
